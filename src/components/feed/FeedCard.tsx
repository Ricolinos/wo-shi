...
import { Column, Row, Avatar, Text, Tag } from "@once-ui-system/core"
  ...
  return (
    <Column fillWidth radius="l" border="neutral-alpha-weak" background="surface" padding="16" gap="12">
      <Row fillWidth vertical="center" gap="8">
        <Avatar src={entry.user.avatar ?? undefined} value={entry.user.name?.slice(0, 2) ?? entry.user.username.slice(0, 2)} size="s" />
        <Column flex={1} gap="0">
